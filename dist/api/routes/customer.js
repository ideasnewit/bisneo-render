...
router
    .route("/export")
    .get(customerRules.filter, validate, filter.customer, customerController.exportCustomers);
router.route("/import").post(validate, customerController.importCustomers);
router
    .route("/:id")
