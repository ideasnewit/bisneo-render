...
router
    .route("/export")
    .get(categoryRules.filter, validate, filter.category, categoryController.exportCategories);
router.route("/import").post(validate, categoryController.importCategories);
router
    .route("/:id")
